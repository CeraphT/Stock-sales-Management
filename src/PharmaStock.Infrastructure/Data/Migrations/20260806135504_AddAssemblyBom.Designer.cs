...
namespace PharmaStock.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260806135504_AddAssemblyBom")]
    partial class AddAssemblyBom
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaStock.Domain.Models.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PharmaStock.Domain.Models.BillOfMaterialLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("AssemblyProductId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PharmaStock.Domain.Models.Company", b =>
                {
                    ...
                    b.Property<bool>("AssemblyEnabled")
                    ...
                    b.Property<bool>("SellByMeasureEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("PharmaStock.Domain.Models.Device", b =>
                {
                    ...
                    b.Property<string>("GeoResolvedForIp")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PharmaStock.Domain.Models.Product", b =>
                {
                    ...
                    b.Property<int>("UnitsPerMeasure")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PharmaStock.Domain.Models.ProductSerial", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProductId", "LocationId", "Status");
            ...
            modelBuilder.Entity("PharmaStock.Domain.Models.User", b =>
                {
                    ...
                    b.Property<bool>("RestrictCashRegister")
                        .HasColumnType("boolean");

                    b.Property<bool>("RestrictCatalog")
                        .HasColumnType("boolean");

                    b.Property<bool>("RestrictCustomers")
                        .HasColumnType("boolean");

                    b.Property<bool>("RestrictGiftCards")
                        .HasColumnType("boolean");

                    b.Property<bool>("RestrictPurchasing")
                        .HasColumnType("boolean");

                    b.Property<bool>("RestrictReportsAndFullSales")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("PharmaStock.Domain.Models.BillOfMaterialLine", b =>
                {
                    b.HasOne("PharmaStock.Domain.Models.Product", "AssemblyProduct")
                        .WithMany("BillOfMaterials")
                        .HasForeignKey("AssemblyProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PharmaStock.Domain.Models.Product", "ComponentProduct")
                        .WithMany()
            ...
            modelBuilder.Entity("PharmaStock.Domain.Models.Product", b =>
                {
                    ...
                    b.HasOne("PharmaStock.Domain.Models.Product", "ParentProduct")
                        .WithMany()
