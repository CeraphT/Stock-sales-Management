...
export function PrintLabels() {
  ...
  function print() {
    ...
    // Render into a hidden iframe and open the OS print dialog (which doubles as
    // "Save as PDF"). Works in a plain browser and the Tauri webview alike —
    // window.open is unreliable in the desktop webview.
    ...
    if (!doc) {
      ...
      toast(t("Could not open the print dialog."), "error");
      return;
    }
    doc.open();
    doc.write(html);
