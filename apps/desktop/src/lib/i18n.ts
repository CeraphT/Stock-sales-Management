...
export const FR: Record<string, string> = {
  ...
  "Sold by weight / measure": "Vendu au poids / à la mesure",
  ...
  "Clothing / fashion": "Vêtements / mode",
  ...
  "e.g. damaged / expired / wrong item": "ex. endommagé / périmé / mauvais article",
  "Stock count": "Comptage de stock",
  "Enter the physically-counted quantity for each batch. Only rows that differ from the system count are adjusted.": "Saisissez la quantité physiquement comptée pour chaque lot. Seules les lignes différentes du stock système sont ajustées.",
  "Search product or batch…": "Rechercher un produit ou un lot…",
  "System": "Système",
  "Variance": "Écart",
  ...
  "Alerts": "Alertes",
  "Nothing needs attention right now.": "Rien ne nécessite d'attention pour le moment.",
  "units": "unités",
  "batch": "lot",
  "d ago": "j",
  "d": "j",
  "Print labels": "Imprimer des étiquettes",
  "Search a product to add…": "Rechercher un produit à ajouter…",
  "no barcode": "sans code-barres",
  "No barcode": "Sans code-barres",
  "Add products to print price/barcode labels.": "Ajoutez des produits pour imprimer des étiquettes prix/code-barres.",
  "label(s)": "étiquette(s)",
  "Labels": "Étiquettes",
